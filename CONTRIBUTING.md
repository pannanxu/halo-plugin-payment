> 欢迎你参与 Halo Payment Plugin 的开发，下面是参与代码贡献的指南，以供参考。
...
```bash
git clone https://github.com/{YOUR_USERNAME}/halo-plugin-payment
...
```bash
git remote add upstream git@github.com:pannanxu/halo-plugin-payment.git
